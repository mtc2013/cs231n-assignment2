...
def affine_forward(x, w, b):
    ...
    for num in x.shape[1:]:
        length *= num
    x_rolled_out = x.reshape(x.shape[0], length) #nxD
    out = x_rolled_out.dot(w) + b
    ###########################################################################
    #                             END OF YOUR CODE                            #
    ###########################################################################
    cache = (x, w, b)
...
def affine_backward(dout, cache):
    ...
    for num in x.shape[1:]:
        length *= num 
    x_rolled_out = x.reshape(x.shape[0],length)
    
    dw = x_rolled_out.T.dot(dout)
    
    dx = dout.dot(w.transpose()) #NXD
...
def relu_backward(dout, cache):
    ...
    ###########################################################################
    dx = (x > 0).astype(int).astype(float) #NXH
    dx *= dout #NXH
    ###########################################################################
    #                             END OF YOUR CODE                            #
    ###########################################################################
